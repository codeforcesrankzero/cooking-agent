...
**Docker + docker-compose** — стандарт для multi-service проектов. У нас три сервиса (app, prometheus, grafana), compose поднимает всё одной командой.
...
**Prometheus + Grafana** — стандартный open-source стек для мониторинга.
...
| 2 | Prometheus метрики (requests, latency, stage duration, search hits) | Андрей + Василий |
| 3 | Grafana дашборд (9 панелей) | Андрей |
...
[Grafana дашборд — основные панели](dash1.png)                                                                                     
                                                                                                                                  
[Grafana дашборд — search hits и latency](dash2.png)    
